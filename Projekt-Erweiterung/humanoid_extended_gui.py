...
from humanoid_extended_render import HumanoidRenderer, RendererUnavailable
...
#: CrossQ und TQC sind geschätzt: CrossQ rechnet mit vierfach breiterem Critic,
#: TQC mit 2 x 25 Quantilen je Update. Nach dem ersten Lauf durch Messwerte
#: ersetzen.
MEASURED_STEPS_PER_SECOND = {"PPO": 481.0, "TD3": 50.0, "SAC": 50.0,
                             "CrossQ": 30.0, "TQC": 35.0}
...
DEFAULT_SLOT_ALGORITHMS = ("SAC", "CrossQ", "TQC", "SAC")
...
SHORT_LABELS = {
    ...
    "batch_norm_momentum": "BN-Mom.", "renorm_warmup_steps": "Warmlauf",
    "n_quantiles": "Quantile", "top_quantiles_to_drop": "Verworfen",
...
#: CrossQ führt keine Target-Netze und kennt deshalb kein `tau` – es gäbe
#: nichts, das weich nachgezogen werden könnte.
_REPLAY_OHNE_TARGET = ("buffer_size", "learning_starts", "train_freq", "gradient_steps")
...
PARAMETER_GROUPS: dict[str, tuple[tuple[str, str, tuple[str, ...]], ...]] = {
    ...
    "CrossQ": (
        _TRAINING_GROUP,
        ("left", "Replay Buffer und Updates", _REPLAY_OHNE_TARGET),
        ("left", "Normalisierung", _NORMALIZATION),
        _NETWORK_GROUP,
        ("right", "Batch Normalization",
         ("batch_norm_momentum", "renorm_warmup_steps", "policy_delay")),
        ("right", "Entropieregularisierung",
         ("ent_coef_value", "target_entropy", "ent_coef_mode")),
        ("right", "Exploration (optional)",
         ("log_std_init", "sde_sample_freq", "action_noise_sigma", "use_sde", "action_noise")),
    ),
    "TQC": (
        ...
        ("left", "Normalisierung", _NORMALIZATION),
        _NETWORK_GROUP,
        ("right", "Verteilungs-Critic", ("n_quantiles", "top_quantiles_to_drop")),
        ("right", "Entropieregularisierung",
         ("ent_coef_value", "target_entropy", "target_update_interval", "ent_coef_mode")),
        ("right", "Exploration (optional)",
         ("log_std_init", "sde_sample_freq", "action_noise_sigma", "use_sde", "action_noise")),
...
class HumanoidGUI:
    ...
    def _window(self) -> None:
        ...
        self.root.title("Humanoid Workbench – Erweiterung")
    ...
    def _layout(self) -> None:
        ...
        ttk.Label(header, text="Humanoid Workbench – Erweiterung",
                  font=("TkDefaultFont", 18, "bold")).pack(side="left")
        ttk.Label(header, text="SAC, CrossQ und TQC – hilft ein neuerer Critic "
                               "bei gleichem Budget?").pack(side="left", padx=16)
    ...
    def manual_text() -> str:
        ...
        return (
            ...
            f"   {DEFAULT_SLOT_COUNT} = SAC, CrossQ und TQC). Gern auch mehrfach derselbe\n"
            "   Algorithmus, um Parametrisierungen zu vergleichen.\n"
            ...
            "Warum beides: Eine Episode endet beim Sturz – 1000 Episoden sind mal\n"
            "25.000, mal 1.000.000 Schritte. Fair vergleicht allein das Schrittbudget:\n"
            "Sonst bekäme das Verfahren, das besser lernt, mehr Trainingsdaten.\n"
            "\n"
            "Environment\n"
            ...
            "noch Strafe am Ende: Ein Sturz kostet nur die entgangenen Rewards.\n"
            ...
            "\n"
            "Methoden\n"
            "Verglichen werden drei Verwandte: SAC als Referenz, CrossQ und TQC. Alle\n"
            "drei sind off-policy, haben einen stochastischen Actor und regeln ihre\n"
            "Entropie selbst – sie unterscheiden sich allein im Critic.\n"
            "SAC nimmt das Minimum zweier Critics gegen Überschätzung. TQC schätzt eine\n"
            "VERTEILUNG über N_q Quantile und wirft je Critic die k obersten weg.\n"
            "CrossQ streicht die Target-Netze: Aktueller und nächster Zustand laufen\n"
            "gemeinsam durch den Critic, Batch Normalization stabilisiert. Deshalb hat\n"
            "es WEDER 'Soft-Update τ' NOCH 'Target-Intervall C', dafür einen vierfach\n"
            "breiteren Critic (1024 statt 256) – Teil des Verfahrens, nicht angeglichen.\n"
            "PPO und TD3 bleiben wählbar, gehören hier aber nicht zum Vergleich.\n"
            "\n"
            "Diagramme\n"
            ...
            "laufen – nur 80 bis 91 % des Returns, dafür ohne Explorationsglück.\n"
            ...
            "Gemessen: SAC rund 50 Schritte/s. CrossQ und TQC rechnen je Update mehr\n"
            "(breiterer Critic, 2 x 25 Quantile) und sind entsprechend langsamer – ein\n"
            "voller Lauf dauert Stunden. Über 100.000 Schritte fragt die Anwendung\n"
            "vorher nach und nennt die erwartete Dauer.\n"
            ...
            "Prozesses aus, alle teilen sich denselben Pool. Von den 6 Kernen sind nur 2\n"
            "Performance-Kerne; nimmt PyTorch alle sechs, warten die schnellen Threads\n"
            "auf die langsamen – Faktor 3.\n"
            "Jeder Off-Policy-Slot belegt mit dem Standardbuffer rund 1,3 GB.\n"
            "\n"
            "Kein Lernerfolg?\n"
            "Zu kurzes Budget, zu großer Lernstart t₀ oder eine zu hohe Lernrate. Bei\n"
            "TQC zusätzlich: k zu klein gewählt, dann bleibt die Überschätzung stehen.\n"
            "Zur Einordnung: Der Zoo-Benchmark erreicht bei 2 Mio. Schritten mit SAC\n"
            "rund 6.232."
        )
